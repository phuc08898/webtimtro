...
<div>
    ...
    <div id="slides" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="intro-slide" src="./assets/image/banner/banne1.jpg" alt="banner">
              <div class="carousel-caption d-none d-md-block" style="text-shadow: 2px 2px 2px #000;">
                <p class="font-italic font-weight-bold">"tìm trọ an toàn"</p>
              </div>
            </div>
            <div class="carousel-item">
              <img class="intro-slide" src="./assets/image/banner/banne2.jpg" alt="banner">
              <div class="carousel-caption d-none d-md-block" style="text-shadow: 2px 2px 2px #000;">
                <p class="font-italic font-weight-bold">"Trọ an nin, tìm trọ nhanh chóng "</p>
              </div>
            </div>
            <div class="carousel-item">
              <img class="intro-slide" src="./assets/image/banner/banne3.jpg" alt="banner">
              <div class="carousel-caption d-none d-md-block" style="text-shadow: 2px 2px 2px #000;">
                <p class="font-italic font-weight-bold">"Gía rẻ hợp túi tiền "</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container mt-60">
            <h2 class="text-dark text-center">Trọ đánh giá 5 sao</h2>
            <p class="text-secondary text-center">
                <i>Những trọ được khách hàng ưu thích nhất</i>
            </p>
            <div class="row mt-60">
            <?php
    ...
    <div class="container text-center">
        <h2 class="text-dark">Thông Tin Liên Hệ Đặt Trọ   </h2>
        <p class="text-dark">
            <i
                >Chúng tôi cam kết mang đến những trọ có chất lượng đảm
                bảo cho bạn</i
            >
        </p>
    </div>
